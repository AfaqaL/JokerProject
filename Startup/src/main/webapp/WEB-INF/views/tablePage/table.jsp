...
<div style="color: blueviolet" id="main-content" class="container">
    <div class="players">
        <div class="player1">
            <label>Player1:</label>
            <% for (int i = 0; i < 9; i++) { %>
        ...
        <div class="player3">
            ...
            <script>
                function func(i){
                    ...
                    currCard.remove();
                    currCard.disabled = true;
                    document.getElementById("moves").appendChild(currCard).appendChild(document.createElement("br"));
                }
            </script>
            <%}%>
            <br>
